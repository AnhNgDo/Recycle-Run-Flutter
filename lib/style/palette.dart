...
class Palette {
  ...
  PaletteEntry get textHeader =>
      const PaletteEntry(Color.fromARGB(255, 248, 158, 40));
  PaletteEntry get text => const PaletteEntry(Color(0xee352b42));
  PaletteEntry get textSecondary =>
      const PaletteEntry(Color.fromARGB(255, 148, 148, 148));
  PaletteEntry get textHud =>
      const PaletteEntry(Color.fromARGB(255, 255, 255, 255));
